...
fun main() {
    ...
    //RESTA
    resu1 = operar(10, 5, ::restar)
    println("La resta de 10 y 5 es $resu1")
    //Ejemplo hecho para la suma. Expresión lambda
    resu1 = operar(10, 5, {x, y -> x - y})
    println("La resta de 10 y 5 es $resu1")

    //MULTIPLICACION
    resu1 = operar(10, 5, ::multiplicar)
    println("La multiplicacion de 10 y 5 es $resu1")
    //Ejemplo hecho para la multiplicacion. Expresión lambda
    resu1 = operar(10, 5, {x, y -> x * y})
    println("La multiplicacion de 10 y 5 es $resu1")

    //DIVISION
    resu1 = operar(10, 5, ::dividir)
    println("La division de 10 entre 5 es $resu1")
    //Ejemplo hecho para la division. Expresión lambda
    resu1 = operar(10, 5, {x, y -> x / y})
    println("La division de 10 entre 5 es $resu1")
